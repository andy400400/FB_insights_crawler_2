...
x1<-chiao_talk$MY+chiao_talk$HK+chiao_talk$SG+chiao_talk$ID+chiao_talk$CN+chiao_talk$JP

value_range <- range(0,x1)

plot(x1, type="o", col="blue", ylim=value_range,axes=FALSE, ann=FALSE)
##
x2<-ilan_talk$MY+ilan_talk$HK+ilan_talk$SG+ilan_talk$ID+ilan_talk$CN+ilan_talk$JP

value_range <- range(0,x2)

plot(x2, type="o", col="blue", ylim=value_range,axes=FALSE, ann=FALSE)
##
x3<-lotung_talk$MY+lotung_talk$HK+lotung_talk$SG+lotung_talk$ID+lotung_talk$CN+lotung_talk$JP

value_range <- range(0,x3)

plot(x3, type="o", col="blue", ylim=value_range,axes=FALSE, ann=FALSE)
##
x4<-suao_talk$MY+suao_talk$HK+suao_talk$SG+suao_talk$ID+suao_talk$CN+suao_talk$JP

value_range <- range(0,x4)

plot(x4, type="o", col="blue", ylim=value_range,axes=FALSE, ann=FALSE)
##
x5<-toucheng_talk$MY+toucheng_talk$HK+toucheng_talk$SG+toucheng_talk$ID+toucheng_talk$CN+toucheng_talk$JP
