#TOTAL
all<-dir(paste("C:/pro/data/plot_data",sep = ""))

#DIV
#all<-dir(paste("C:/pro/data/div_data",sep = ""))
...
for (x in 1:file_length) {
  ...
  #DIV
  #add_path<-paste("C:/pro/data/div_data/",all[x],sep = "")
...
#talk
{
  ...
  axis(2, las=1, at=30000*0:value_range[2])
  ...
  legend("topleft", g_range[2], c("chiao","ilan","lotung","suao","toucheng"), cex=0.8, col=c("blue","red"), pch=21:22, lty=1:2)
}
